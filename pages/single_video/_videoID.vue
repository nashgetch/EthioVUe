    ...
    <div class="row rowDiv">
      <div class="col-lg-8 col-xs-12 col-sm-12">
        ...
        <div class="content-wrapper" style="margin: 0 !important;">
          <h1 style="padding-top: 7px;">{{ single.title }}</h1>
        </div>
        ...
        <div class="content-wrapper">
          ...
          <div class="author">
            <div class="author-head" ng-controller="navController">
              <nuxt-link :to="'/single_channel/'+owner.id">
                <img :src="pos_url+owner.poster_image" alt class="sv-avatar">
              </nuxt-link>
              <div class="sv-name">
                <div>
                  <a></a>
            ...
            <div class="thumb row" v-for="(re,$index) in recommended" :key="$index">
              <div class="col-lg-6 col-sm-6" ng-click="viewVideo(re.v_id)">
                <div class="Vimg itemContainer" style="background-color: #0c0c0c">
                  <img class="imgur" heigth="400" width="400" :src="pos_url + '/'+re.filename2" alt>
                  <nuxt-link :to="'/single_video/'+re.v_id">
