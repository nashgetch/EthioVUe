<template>
  <div class="quick-menu" ref="quickMenu" :style="quickMenuStyle">
    ...
    <div class="menu" :style="menuStyle">
      <div class="core-menu" style="font-size: 40px;" @click="toggleMenu">
        <div class="bar"></div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      menuSize: 60,
      subMenu4: [
        [["30", "-160"], ["-80", "-115.6"], ["-138.6", "-80"], ["-148", "0"]],
        [["30", "-160"], ["80", "-115.6"], ["138.6", "-80"], ["148", "0"]],
        [["30", "160"], ["115.6", "80"], ["80", "138.6"], ["148", "0"]],
        [["-160", "0"], ["115.6", "80"], ["-80", "138.6"], ["0", "148"]]
      ],
      subMenu3: [
        [["-160", "0"], ["-113", "-113"], ["0", "-130"]],
        [["-120", "-160"], ["113", "-113"], ["130", "0"]],
        [["-120", "160"], ["113", "113"], ["130", "0"]],
        [["-160", "0"], ["-113", "113"], ["0", "130"]]
      ],
      subMenu2: [
...
.quick-menu {
  ...
  .sub-menu {
    ...
    font-size: 10px;
    text-align: center;
    box-shadow: 0 5px 16px 0 rgba(0, 0, 0, 0.16), 0 10px 19px 10px rgba(0, 0, 0, 0.3);
